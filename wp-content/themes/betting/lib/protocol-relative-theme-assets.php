...
if ( ! class_exists( 'betting_Protocol_Relative_Theme_Assets' ) ) :

	/**
	 * betting_Protocol_Relative_Theme_Assets class
	 */
	class betting_Protocol_Relative_Theme_Assets {
		/**
	...
	$betting_protocol_relative_theme_assets = new betting_Protocol_Relative_Theme_Assets();
endif;
