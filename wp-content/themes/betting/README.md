...
$ git clone https://gitlab.betting.se/dmitriy.olhovsky/betting-starter.git
$ rename betting-theme folder (better with underscores or together like in 'twentyseventeen')
$ cd your_theme_name
```
...
$ find & replace 'betting_' and 'betting' in the whole theme with your theme name
